...

{
  ...
  home-manager = {
    ...
    users.gooze =
      ...
      programs.zen-browser = {
        ...
        # theme-name) follows the modules.desktop.session option.
  ...
  # GNOME, swap the noctalia.nix import for the gnome-* modules (kept as
  # dormant code — no host uses them by default).
